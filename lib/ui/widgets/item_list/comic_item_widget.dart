...
class ComicItemWidget extends ConsumerWidget {
  ...
  const ComicItemWidget({super.key, required this.comic});
        ...
        child: Stack(
          children: [
            ClipRRect(
              ...
              child: Image.network(
                comic.image ?? Config.defaultImage,
                width: double.infinity,
                fit: BoxFit.fill,
              ),
            ),
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        comic.title ?? 'Comic without Title',
                        maxLines: 2,
                      ...
                      Text(
                        comic.description ?? 'Comic without Description',
                        maxLines: 4,
                        overflow: TextOverflow.ellipsis,
